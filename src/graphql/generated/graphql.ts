...
export type TasksQuery = { tasks: Array<{ id: string, name: string, dueDate: string, pointEstimate: PointEstimate, position: number, createdAt: string, status: Status, tags: Array<TaskTag>, assignee: { id: string, fullName: string, avatar: string | null } | null }> };
