...
export function Sidebar({ open, onClose }: SidebarProps) {
  return (
    <>
      ...
      <aside
        id="app-sidebar"
        className={`${open ? 'translate-x-0' : '-translate-x-full'} fixed inset-y-0 left-0 z-40 w-77.5 overflow-hidden bg-neutral-4 transition-transform lg:static lg:z-auto lg:h-full lg:w-64 lg:shrink-0 lg:translate-x-0 lg:rounded-3xl`}
      >
